...
function giveIntroduction () {
    game.setDialogFrame(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    game.setDialogCursor(assets.image`Apple`)
    showInstruction("Welcome To Immunity.    - By Aarav Kapasi")
    showInstruction("Our World Is Being Attacked By Viruses...")
    showInstruction("...And You Have To Survive It By...")
    showInstruction("...Following The Healthy Lifestyle ")
...
function initializeCoinAnimation () {
    ...
    coinAnimation.addAnimationFrame(assets.image`Apple`)
}
...
function initializeFlierAnimations () {
    ...
    flierFlying.addAnimationFrame(assets.image`Pastries`)
